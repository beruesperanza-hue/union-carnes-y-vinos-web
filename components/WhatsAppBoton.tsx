...
export default function WhatsAppBoton({ en = false }: { en?: boolean }) {
  return (
    <a
      href={NEGOCIO.whatsappUrl}
      target="_blank"
      rel="noopener noreferrer"
      aria-label={en ? 'Chat with us on WhatsApp' : 'Escribinos por WhatsApp'}
    ...
    >
      ...
      <span>{en ? 'WhatsApp' : 'Escribinos'}</span>
    </a>
  );
}
